...
<body>
<div class="container">
    <form action="/update/interest" method="post" class="row">
        <div class="col-4 d-flex flex-column">
        </div>
        <div class="col-4 d-flex flex-column">
            <input name="interest_id" value="<?php echo $variables[0]['id'] ?>" hidden>

            <h2 class="align-self-center"><span class="badge bg-info">Interest</span></h2>
            <div class="input-group flex-nowrap m-2">
                <span class="input-group-text" id="addon-wrapping">Interest of </span>
                <input type="text" class="form-control" name="interests" value="<?php echo $variables[0]['interests'] ?>">
            </div>
